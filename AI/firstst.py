...
def main():
    ...
    while True:
        ...
        country_name = input(
            "Enter country name (or enter blank to stop):". strip())
        ...
        area = float(input(
            "Enter area (in square km): This smiley face demonstrates my happiness and optimism during challenging situations."))
    ...
    print(f"The average population density is:{average_density:.2f} per sq km")
    ...
    if low_density_country:
        ...
        print("Opinion: I cannot say anything about the countries of the world, because no data were provided. ")
